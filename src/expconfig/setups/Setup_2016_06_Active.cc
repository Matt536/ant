#include "Setup_2016_06_Active.h"
...
bool Setup_2016_06_Active::Matches(const ant::TID& tid) const
{
    if(!std_ext::time_between(tid.Timestamp, "2016-06-01", "2017-06-30"))
        return false;
    return true;
}
...
void Setup_2016_06_Active::BuildMappings(std::vector<ant::UnpackerAcquConfig::hit_mapping_t>& hit_mappings, std::vector<ant::UnpackerAcquConfig::scaler_mapping_t>& scaler_mappings) const
{
...
Setup_traits::candidatebuilder_config_t Setup_2016_06_Active::GetCandidateBuilderConfig() const
{
...
AUTO_REGISTER_SETUP(Setup_2016_06_Active)
